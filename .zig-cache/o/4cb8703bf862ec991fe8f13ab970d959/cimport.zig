...
pub const clock_t = c_long; // /usr/include/bits/alltypes.h:50:1: warning: struct demoted to opaque type - has bitfield
...
pub const struct__fpstate = extern struct {
    ...
    mxcsr: c_uint = 0,
    mxcr_mask: c_uint = 0,
    _st: [8]struct_unnamed_2 = @import("std").mem.zeroes([8]struct_unnamed_2),
    _xmm: [16]struct_unnamed_3 = @import("std").mem.zeroes([16]struct_unnamed_3),
...
const union_unnamed_6 = extern union {
    __piduid: struct_unnamed_7,
    __timer: struct_unnamed_8,
};
...
const union_unnamed_9 = extern union {
    ...
    __sigchld: struct_unnamed_10,
};
const struct_unnamed_5 = extern struct {
    __first: union_unnamed_6 = @import("std").mem.zeroes(union_unnamed_6),
    __second: union_unnamed_9 = @import("std").mem.zeroes(union_unnamed_9),
};
...
const union_unnamed_12 = extern union {
    __addr_bnd: struct_unnamed_13,
    si_pkey: c_uint,
};
const struct_unnamed_11 = extern struct {
    si_addr: ?*anyopaque = null,
    si_addr_lsb: c_short = 0,
    __first: union_unnamed_12 = @import("std").mem.zeroes(union_unnamed_12),
};
...
const union_unnamed_4 = extern union {
    __pad: [112]u8,
    __si_common: struct_unnamed_5,
    __sigfault: struct_unnamed_11,
    __sigpoll: struct_unnamed_14,
    __sigsys: struct_unnamed_15,
};
pub const siginfo_t = extern struct {
    si_signo: c_int = 0,
    si_errno: c_int = 0,
    si_code: c_int = 0,
    __si_fields: union_unnamed_4 = @import("std").mem.zeroes(union_unnamed_4),
...
pub const struct_sigaction = extern struct {
    __sa_handler: union_unnamed_16 = @import("std").mem.zeroes(union_unnamed_16),
...
const union_unnamed_17 = extern union {
    ...
    __sev_thread: struct_unnamed_18,
};
pub const struct_sigevent = extern struct {
    sigev_value: union_sigval = @import("std").mem.zeroes(union_sigval),
    sigev_signo: c_int = 0,
    sigev_notify: c_int = 0,
    __sev_fields: union_unnamed_17 = @import("std").mem.zeroes(union_unnamed_17),
};
