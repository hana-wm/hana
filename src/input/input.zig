...
pub fn handleKeyPress(event: *const xcb.xcb_key_press_event_t, wm: *WM) void {
    ...
    if (state.get(key)) |action| {
        // FIX: Reset event counter before executing action to prevent spurious focus changes
        // This protects against EnterNotify events generated by key grab releases
